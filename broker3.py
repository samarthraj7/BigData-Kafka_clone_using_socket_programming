...
serverSocket.bind(('localhost' ,12003)) 
serverSocket.listen(10) 
print('[BROKER3 RUNNING]') 
...
try:
    os.mkdir(WORKING_DIRECTORY+'/broker3')
except Exception as e:
    shutil.rmtree(WORKING_DIRECTORY+'/broker3')
    os.mkdir(WORKING_DIRECTORY+'/broker3')



f=open(WORKING_DIRECTORY+'/broker3/'+'log.txt','w')
f.close()
clientSocket.send('im alive'.encode())
while True: 
